...
<template>
    <div class="z-50 bottom-0 h-full w-full">
        <div class="py-2 w-full">
            <!-- Profile section with vertical line container -->
            <div class="relative">
                <!-- Profile header -->
                    ...
                    <div class="flex items-center text-white">
                        <div class="relative">
                            <img :src="post?.image || '/default-avatar.png'" :alt="post?.name || 'User'"
                                class="rounded-full h-[35px] w-[35px] object-cover z-10 relative">
                        </div>
                ...
                <div class="absolute left-[17px] top-10 w-[1px] bg-gray-700 h-[calc(100%-70px)]" />

                <!-- Main content -->
                <div class="w-[calc(100%-50px)] ml-auto bg-black rounded-lg font-light text-sm relative mt-2">
                ...
                <!-- Bottom images -->
                <div class="relative text-gray-500 pt-1 pb-1.5 ml-[17px]">
                    <div class="flex items-center">
                        <div class="flex items-center flex-wrap text-white gap-1">
                            <div class="flex items-center gap-1">
                            ...
                            <div class="flex items-center">
                                <img src="https://picsum.photos/id/99/50" alt="" class="rounded-full h-[11px]">
                            </div>
                        </div>
                    </div>
                </div>
